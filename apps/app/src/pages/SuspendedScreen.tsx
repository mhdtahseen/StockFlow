  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-dvh bg-slate-50 dark:bg-slate-950 p-6 text-center">
      ...
      <div className="grid gap-3 w-full max-w-xs">
        <Button asChild variant="outline" className="rounded-xl h-12 font-bold gap-2 border-slate-200 dark:border-slate-800 shadow-sm">
          <a href="mailto:support@finventree.com?subject=Organization%20Suspended%20-%20Help%20Needed">
