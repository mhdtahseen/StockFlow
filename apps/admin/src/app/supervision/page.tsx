...
function SupervisionContent() {
  ...
  const handleSuspend = async (duration: string) => {
    ...
    if (duration === "1h") resumeAt.setHours(resumeAt.getHours() + 1);
      ...
      resumeAt.setFullYear(resumeAt.getFullYear() + 100);
  ...
  return (
    <div className="p-4 sm:p-5 w-full space-y-5 pb-32">
      ...
      {stats && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <div className="bg-emerald-50/30 dark:bg-emerald-900/10 p-4 rounded-xl border border-emerald-100 dark:border-emerald-800/20">
            ...
            <p className="text-xl sm:text-2xl font-bold mt-1 tracking-tight text-emerald-600 dark:text-emerald-400">
              99.8%
            </p>
          </div>
        </div>
        ...
        <DialogContent className="rounded-2xl max-w-[95vw] sm:max-w-md w-full">
          <DialogHeader className="space-y-2">
            ...
            <DialogDescription className="text-slate-600 font-medium leading-relaxed">
              ...
              {deleteType === "tenant" && (
                <span className="block text-orange-600 mt-3 text-xs">
          ...
          <DialogFooter className="mt-6 gap-3 flex-col sm:flex-row">
            <Button
              ...
              className="rounded-xl font-bold h-11 w-full sm:flex-1"
            >
              Abort
            </Button>
            <Button
              ...
              className="rounded-xl bg-rose-600 hover:bg-rose-700 text-white font-bold h-11 w-full sm:flex-1"
            >
      ...
      <Dialog
        open={!!suspensionId}
        onOpenChange={() => setSuspensionId(null)}
      >
