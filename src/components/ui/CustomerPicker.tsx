...
export function CustomerPicker({ selectedId, onSelect }: Props) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent
        side="bottom"
        className="h-[80vh] flex flex-col p-4 sm:p-6 rounded-t-3xl border-t border-slate-200 dark:border-slate-800"
      >
          ...
          <>
            <div className="relative mb-4">
              ...
              <Input
                ...
                className="pl-10 h-12 bg-slate-50 dark:bg-slate-900 border-transparent focus-visible:ring-primary-500 rounded-xl"
              />
            </div>
              ...
              {query.trim() &&
                !results.some(
                  ...
                  <button
                    ...
                    className="w-full mt-2 p-3 rounded-xl bg-blue-50/50 dark:bg-primary-500/10 text-primary-500 dark:text-blue-400 font-semibold hover:bg-blue-100 dark:hover:bg-primary-500/20 transition-colors flex items-center justify-center gap-2"
                  >
                    <Plus size={18} />
          ...
          <form onSubmit={handleCreate} className="flex flex-col gap-4 flex-1">
            ...
            <div>
              ...
              <select
                ...
                className="w-full h-12 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm shadow-none focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary-500 dark:border-slate-800 dark:bg-slate-900 dark:focus-visible:ring-blue-500 font-medium"
              >
                <option value="CUSTOMER">Retail standard</option>
            ...
            <div className="mt-auto grid grid-cols-2 gap-3 pt-6">
              ...
              <Button
                type="submit"
                className="h-12 bg-primary-500 hover:bg-blue-800 text-white rounded-xl font-bold"
              >
                Save & Select
              </Button>
            </div>
